...
{
    public class LightenBlendTests
    {
        private readonly IBlendMode blendMode = new LightenBlend();
        ...
        public void Blend_ReturnsAddedHeightMaps()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.5d, 0.75d },
                                           { 1.0d, 0.5d } };
        ...
        public void Blend_RightSourceIsSmaller()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.5d, 0.75d, 0.5d },
                                           { 1.0d, 0.5d, 0.5d },
                                           { 0.5d, 0.5d, 0.5d } };
            var heightMapA = new HeightMap(dataA);
            var heightMapB = new HeightMap(dataB);
