...
{
    public class OverlayBlendTests
    {
        private readonly IBlendMode blendMode = new OverlayBlend();
        ...
        public void Blend_ReturnsAddedHeightMaps()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.0d, 0.6d },
                                           { 1.0d, 0.7d } };
        ...
        public void Blend_RightSourceIsSmaller()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.0d, 0.6d, 0.25d },
                                           { 1.0d, 0.7d, 0.5d },
                                           { 0.25d, 0.5d, 0.75d } };
            var heightMapA = new HeightMap(dataA);
            var heightMapB = new HeightMap(dataB);
