...
{
    public class DarkenBlendTests
    {
        private readonly IBlendMode blendMode = new DarkenBlend();
        ...
        public void Blend_ReturnsAddedHeightMaps()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.0d, 0.5d },
                                           { 0.5d, 0.25d } };
        ...
        public void Blend_RightSourceIsSmaller()
        {
            ...
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.0d, 0.5d, 0.5d },
                                           { 0.5d, 0.25d, 0.5d },
                                           { 0.5d, 0.5d, 0.5d } };
            var heightMapA = new HeightMap(dataA);
            var heightMapB = new HeightMap(dataB);
