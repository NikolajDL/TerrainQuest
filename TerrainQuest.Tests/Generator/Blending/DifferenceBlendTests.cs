...
{
    public class DifferenceBlendTests
    {
        private readonly IBlendMode blendMode = new DifferenceBlend();
        ...
        public void Blend_ReturnsAddedHeightMaps()
        {
            ...
            var dataA = new double[,] { { 0.2d, 0.4d },
                                        { 0.6d, 0.8d } };
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.2d, 0.35d },
                                           { 0.4d, 0.55d } };
        ...
        public void Blend_RightSourceIsBigger()
        {
            ...
            var dataA = new double[,] { { 0.2d, 0.4d },
                                        { 0.6d, 0.8d } };
            var dataB = new double[,] { { 0.0d, 0.75d, 0.5d },
                                        { 1.0d, 0.25d, 1.0d },
                                        { 0.5d, 1.0d, 2.0d } };
            var expected = new double[,] { { 0.2d, 0.35d },
                                           { 0.4d, 0.55d } };
        ...
        {
            // Arrange
            var dataA = new double[,] { { 0.2d, 0.4d, 0.25d },
                                        { 0.6d, 0.8d, 0.5d },
                                        { 0.25d, 0.5d, 0.75d } };
            var dataB = new double[,] { { 0.0d, 0.75d },
                                        { 1.0d, 0.25d } };
            var expected = new double[,] { { 0.2d, 0.35d, 0.25d },
                                           { 0.4d, 0.55d, 0.5d },
                                           { 0.25d, 0.5d, 0.75d } };
            var heightMapA = new HeightMap(dataA);
            var heightMapB = new HeightMap(dataB);
